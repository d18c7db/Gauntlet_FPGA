...
The modified VHDL files that make the game run at SVGA resolution are in this folder. Also precompiled .rbf files are provided here for the MiSTer FPGA platform so curious souls can experience this mod to the game.  
