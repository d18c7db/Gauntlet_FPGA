...
set_clock_groups -exclusive \
   ...
   -group [get_clocks { pll_hdmi|pll_hdmi_inst|altera_pll_i|*[0].*}] \
   -group [get_clocks { pll_audio|pll_audio_inst|altera_pll_i|*[0].*}] \
...
set_false_path -to [get_ports {IO_SCL IO_SDA SD_SPI_CS SDCD_SPDIF}]
set_false_path -from [get_ports {HDMI_I2C_SDA HDMI_TX_INT IO_SDA VGA_EN SW[*]}]
