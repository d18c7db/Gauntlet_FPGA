...
REM  10000-17FFF  1P     1C   16K-16K GS2 plane 1, 0 plus 16K FF padding
...
REM  50000-57FFF  2P     2C   16K-16K GS2 plane 3, 2 plus 16K FF padding
...
SET SOURCES=%SOURCES% + %ROMS%\136043-1123.1C+16K-FF.BIN
...
SET SOURCES=%SOURCES% + %ROMS%\136043-1125.2C+16K-FF.BIN
SET SOURCES=%SOURCES% + 16K-FF.BIN+16K-FF.BIN
SET SOURCES=%SOURCES% + 16K-FF.BIN+16K-FF.BIN
SET SOURCES=%SOURCES% + 16K-FF.BIN+16K-FF.BIN
SET SOURCES=%SOURCES% + 16K-FF.BIN+16K-FF.BIN
...
SET SOURCES=%SOURCES% + %ROMS%\136043-1124.1P+16K-FF.BIN
SET SOURCES=%SOURCES% + 16K-FF.BIN+16K-FF.BIN
SET SOURCES=%SOURCES% + 16K-FF.BIN+16K-FF.BIN
SET SOURCES=%SOURCES% + 16K-FF.BIN+16K-FF.BIN
SET SOURCES=%SOURCES% + 16K-FF.BIN+16K-FF.BIN
...
SET SOURCES=%SOURCES% + %ROMS%\136043-1126.2P+16K-FF.BIN
SET SOURCES=%SOURCES% + 16K-FF.BIN+16K-FF.BIN
SET SOURCES=%SOURCES% + 16K-FF.BIN+16K-FF.BIN
SET SOURCES=%SOURCES% + 16K-FF.BIN+16K-FF.BIN
SET SOURCES=%SOURCES% + 16K-FF.BIN+16K-FF.BIN
